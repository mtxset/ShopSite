...
namespace ShopSite.Migrations
{
    ...
    [Migration("20170503123750_again change a name of product table")]
    partial class againchangeanameofproducttable
    {
            ...
            modelBuilder.Entity("ShopSite.ProductAttributes.Models.ProductAttribute", b =>
                {
                    ...
                    b.Property<int>("ProductAttributeComplexTypeDefinitionId");

                    b.HasKey("Id");

                    b.HasIndex("CategoryId");

                    b.HasIndex("ProductAttributeComplexTypeDefinitionId");
            ...
            modelBuilder.Entity("ShopSite.ProductAttributes.Models.ProductAttribute", b =>
                {
                    ...
                    b.HasOne("ShopSite.ProductAttributes.Models.ProductAttributeComplexTypeDefinition", "ProductAttributeComplexTypeDefinition")
                        .WithMany()
                        .HasForeignKey("ProductAttributeComplexTypeDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
