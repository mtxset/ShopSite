...
namespace ShopSite.Migrations
{
    ...
    [Migration("20170403055651_attributeGroup")]
    partial class attributeGroup
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ShopSite.Models.Attribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ShopSite.Models.AttributeGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ShopSite.Models.AttributeValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ShopSite.Models.Attribute", b =>
                {
                    b.HasOne("ShopSite.Models.AttributeGroup", "Group")
                        .WithMany("Attributes")
            ...
            modelBuilder.Entity("ShopSite.Models.AttributeValue", b =>
                {
                    b.HasOne("ShopSite.Models.Attribute", "Attribute")
                        .WithMany()
